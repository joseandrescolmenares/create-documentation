            ...
            <div className="flex flex-col items-center text-center space-y-4 mb-11">
              <div className="space-y-2 flex flex-col justify-center items-center m-5 gap-3 relative">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl text-cyan-50">
                  Creé Documentación para sus Repositorios.
                </h1>
                <p className="max-w-[700px] text-slate-50 md:text-xl">
                  Genera documentación precisa y completa para tus repositorios
                  de código en minutos. ¡Facilita el acceso y la comprensión de
                  tus proyectos!
                </p>
              </div>
          ...
          <div className="container grid gap-8 px-4 md:px-6 lg:grid-cols-3 justify-center items-center">
            <div className="grid gap-4 justify-center items-center">
              ...
              <h3 className="text-lg font-bold text-slate-50">
                Explora Módulos y Componentes
              </h3>
              <p className="text-slate-50">
                Descubre una variedad de módulos y componentes disponibles en
            ...
            <div className="grid gap-4 justify-center items-center">
              ...
              <p className="text-slate-50">
                Consulta la documentación para aprender a configurar y
                personalizar nuestra plataforma según tus necesidades.
              </p>
            </div>
            <div className="grid gap-4">
              <BookIcon className="h-8 w-8 text-cyan-50 text-center" />
              <h3 className="text-lg font-bold text-slate-50">
                Domina Con Nuestras Guías
              </h3>
              <p className="text-slate-50">
                Accede a guías paso a paso y tutoriales basados en nuestra
                documentación para dominar nuestra plataforma.
              </p>
            </div>
          </div>
        </section>
